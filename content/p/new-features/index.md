...
Я перевёл блог на новый генератор статических сайтов [Zola](https://www.getzola.org/) (далее «зола»), попутно реализовав много новых фич. Фичи относятся как к купрощению написания статей так и ко всему остальному. Сначала я:
...
* На телефоне
	...
	* Если содержание маленькое, то при открытии через нижню кнопку, автоматически прилипает вниз к ней.
{{ admonition_end() }}

{{ admonition_start(color="gray", title="Техническая сторона") }}
* Стили: [`_toc.scss`](https://github.com/optozorax/blog_zola/blob/master/sass/_toc.scss).
* Скрипты: [`toc.js`](https://github.com/optozorax/blog_zola/blob/master/static/js/toc.js), [`hammer.min.js`](https://github.com/optozorax/blog_zola/blob/master/static/js/hammer.min.js) ([веб-сайт](https://hammerjs.github.io/)).
{{ admonition_end() }}
